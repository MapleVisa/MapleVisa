...
const documentsSection: Section = {
  ...
  fields: [
    { name: "docPassport", label: "Passport", type: "checkbox" },
    { name: "docPhoto", label: "Digital photo", type: "checkbox" },
    { name: "docEca", label: "ECA report", type: "checkbox" },
    { name: "docLanguage", label: "Language test results", type: "checkbox" },
    ...
    { name: "docFunds", label: "Proof of funds", type: "checkbox" },
...
const sponsor: Program = {
  ...
  sections: [
    ...
    backgroundSection,
    {
      ...
      title: "Supporting documents",
      fields: [
        { name: "docPassports", label: "Passports", type: "checkbox" },
        ...
        { name: "docRelationship", label: "Proof of relationship", type: "checkbox" },
...
const business: Program = {
  ...
  sections: [
    ...
    backgroundSection,
    {
      ...
      title: "Supporting documents",
      fields: [
        { name: "docPassport", label: "Passports", type: "checkbox" },
        ...
        { name: "docBank", label: "Bank statements", type: "checkbox" },
